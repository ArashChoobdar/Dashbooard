...
var options = {
	series: [50, 25, 60, 50, 25, 35],
	chart: {
		height: 200,
		type: 'donut',
	},
	labels: ["خاتمه یافته", "ارسالی جدید", "در دست اقدام", "دریافتی جدید", "مجموع ارجاعات", "مختومه، ارسالی و دریافتی"],
	plotOptions: {
		pie: {
			donut: {
				size: '75%'
	...
	colors: ['#EF142E', '#FEC600', '#F99500', '#22D49A', '#0059FE', '#57B7FE'],
